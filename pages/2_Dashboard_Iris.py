...
fig_5 = px.histogram(df[df['Species'] == species], x="PetalLengthCm")
col1.plotly_chart(fig_5, use_container_width=True)

fig_6 = px.box(df[df['Species'] == species], y="PetalLengthCm")
col2.plotly_chart(fig_6, use_container_width=True)


fig_7 = px.histogram(df[df['Species'] == species], x="PetalWidthCm")
col1.plotly_chart(fig_7, use_container_width=True)

fig_8 = px.box(df[df['Species'] == species], y="PetalWidthCm")
